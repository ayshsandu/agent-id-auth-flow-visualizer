...
const ArchitectureDiagram: React.FC<ArchitectureDiagramProps> = ({ activeFlow }) => {
  ...
  const getTooltipPosition = (target: Element) => {
    if (!containerRef.current) return { x: 0, y: 0, align: 'left' as const };
    ...
    >
      ...
      {tooltip && (
        ...
        >
          <div className="bg-slate-800 text-white text-[10px] p-3 rounded-lg shadow-2xl font-mono border border-slate-600 max-w-xs overflow-hidden backdrop-blur-sm bg-opacity-95">
            ...
            <pre className="whitespace-pre-wrap break-all leading-tight text-slate-300 select-text">
              {tooltip.content}
            </pre>
            {tooltip.pinned && (
              <div className="mt-2 pt-1 border-t border-slate-600/50 text-[9px] text-slate-500 italic text-center flex justify-between items-center">
                <span>Pinned</span>
                <span className="opacity-75">Click diagram to close</span>
              </div>
            )}
          </div>
        </div>
      ...
      <svg width="850" height="450" viewBox="0 0 850 450" className="w-full max-w-5xl">
        ...
        <g transform="translate(60, 260)">
          ...
          <text x="0" y="45" textAnchor="middle" className="text-xs font-bold fill-slate-700">Student</text>
        </g>
        ...
        <g transform="translate(580, 140)">
          ...
          <text x="0" y="-30" textAnchor="middle" className="text-sm font-semibold fill-slate-700">Smart Agent</text>
          <text x="0" y="-15" textAnchor="middle" className="text-xs fill-slate-600">(AI Assistant)</text>
          {/* Internal Client Node */}
        ...
        <g transform="translate(800, 200)">
          ...
          <text x="0" y="15" textAnchor="middle" className="text-[8px] fill-slate-500">(Research Server)</text>
        </g>
        ...
        <g transform="translate(800, 340)">
          ...
          <text x="0" y="15" textAnchor="middle" className="text-[8px] fill-slate-500">(Workspace Server)</text>
        </g>
